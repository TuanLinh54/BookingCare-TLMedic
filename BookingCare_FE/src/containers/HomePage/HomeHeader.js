                ...
                <div className='home-header-container'>
                    <div className='home-header-content'>
                        ...
                        <div className='center-content'>
                            ...
                            <Link to={'/clinic'} style={{ textDecoration: 'none', color: 'black' }}>
                                <div className='child-content'>
                                    <div><b><FormattedMessage id="homeheader.health-facility" /></b></div>
                                    <div className='subs-title'><FormattedMessage id="homeheader.choose-room" /></div>
                                </div>
                            </Link>
                            <Link to={`/all-doctor`} style={{ textDecoration: 'none', color: 'black' }}>
                                <div className='child-content'>
                            ...
                            <div className='child-content'>
                                <div><b><FormattedMessage id="homeheader.medpack" /></b></div>
                                <div className='subs-title'><FormattedMessage id="homeheader.generality" /></div>
                            </div>
                        </div>
                        ...
                        <div className='content-down'>
                            <div className='options'>
                                <div className='option-child'>
                                    ...
                                    <div className='text-child'> <FormattedMessage id="banner.specialized-ex" /></div>
                                </div>
                                <div className='option-child'>
                                    <div className='icon-child'><i className="fas fa-mobile-alt"></i></div>
                                    <div className='text-child'> <FormattedMessage id="banner.remote-ex" /></div>
                                </div>
                                <div className='option-child'>
                                ...
                                <div className='option-child'>
                                    ...
                                    <div className='text-child'> <FormattedMessage id="banner.dental-check" /></div>
                                </div>
                            </div>
                        </div>
                    </div>
